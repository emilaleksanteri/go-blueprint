			...
			"advanced": {
				...
				Options: []Item{
...

					{
						Flag:  "React",
						Title: "React",
						Desc:  "Use Vite to spin up a React project in TypeScript. This disables selecting HTMX/Templ and Svelte",
					},
					{
						Flag:  "Htmx",
						Title: "HTMX/Templ",
						Desc:  "Add starter HTMX and Templ files. This disables selecting React and Svelte",
					},
					{
						Flag:  "GitHubAction",
